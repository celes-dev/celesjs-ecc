...
ecc.randomKey().then(privateKey => {
  ...
  console.log('Public Key:\t', ecc.privateToPublic(privateKey)) // CELESkey...
    ...
    */
    privateToPublic: (wif, pubkey_prefix = 'CELES') =>
      PrivateKey(wif).toPublic().toString(pubkey_prefix),

    /**
        @arg {pubkey} pubkey - like CELESKey..
        @arg {string} [pubkey_prefix = 'CELES']

        @return {boolean} valid

        @example ecc.isValidPublic(pubkey) === true
    */
    isValidPublic: (pubkey, pubkey_prefix = 'CELES') =>
    ...
    */
    ...
    /**
        ...
        @arg {String|Buffer} signature (CELESbase58sig.., Hex, Buffer)
