...
/**
  ...
  @param {string} [pubkey_prefix = 'CELES']
*/
function PublicKey(Q, pubkey_prefix = 'CELES') {
    if(typeof Q === 'string') {
     ...
     * @arg {string} [pubkey_prefix = 'CELES'] - public key prefix
    */
    function toString(pubkey_prefix = 'CELES') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'CELES']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'CELES') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'CELES') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'CELES') {
